...
struct KeyEntry_Previews: PreviewProvider {
    static var previews: some View {
        KeyEntry(viewModel: KeyEntry.ViewModel(keyManager: MultipleKeyKeychainManager(isAuthorized: Just(true).eraseToAnyPublisher(), keyDirectoryStorage: DataStorageUserDefaultsSetting()), isShowing: .constant(true)))
    }
}

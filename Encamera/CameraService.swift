    ...
    public func checkForPermissions() {
        ...
        default:
            ...
            DispatchQueue.main.async {
                self.alertError = AlertError(title: "Camera Access", message: "Encamera doesn't have access to use your camera, please update your privacy settings.", primaryButtonTitle: "Settings", secondaryButtonTitle: nil, primaryAction: {
...
//        We use our capture session queue to ensure our UI runs smoothly on the main thread.
    ...
    public func capturePhoto() {
        ...
        sessionQueue.async {
            ...
            if self.photoOutput.availablePhotoCodecTypes.contains(.hevc), let destinationUrl = try? EncameraState.shared.tempFilesManager.createLivePhotoiCloudMovieCaptureUrl() {
            ...
            let photoCaptureProcessor = PhotoCaptureProcessor(with: photoSettings, willCapturePhotoAnimation: { [weak self] in
                // Tells the UI to flash the screen to signal that Encamera took a photo.
                DispatchQueue.main.async {
